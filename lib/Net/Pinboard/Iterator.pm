...
Net::Pinboard::Iterator - iterator class for Net::Pinboard thingies

=head1 SYNOPSIS

 use Net::Pinboard::Iterator;

 my @dates = ({...},{...});
 my $it    = Net::Pinboard::Iterator->new("Date",\@dates);
...
Iterator class for Net::Pinboard thingies
...
Returns a I<Net::Pinboard::Iterator> object. Woot!
